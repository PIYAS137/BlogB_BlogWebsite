...
const MiddleArea = () => {
  ...
  return (
    <React.Fragment>
      ...
      {data.length == 0 ?<h1 className="text-base xl:text-xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-red-500 textce">! . . . No blogs available for <span className='text-white'>{catagoryClick}</span> Catagory . . . !</h1>: null}
